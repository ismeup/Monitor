...
public class StartController {
    ...
    public void start() {
        try {
            ...
            startFromConfiguration(configuration);
    ...
    public void startFromConfiguration(Configuration configuration) throws AesException, ServerBindException, SslInitException {
